...
msg['From'] = fromaddr 
msg['To'] = ', '.join(toaddr)
msg['Subject'] = "Hardsearch Alertas - Coparticipações"

body = ('''Atenção! Existem Coparticipações vencidas, Você deve acessar o sistema para varificar os mesmos.

Enviado por: Alertas Hardsearch - alerta_copart v0.20.0522''')
msg.attach(MIMEText(body)) 

filename = r'C:\Hardsearch\alertaMail\copart_vencida\arq.txt' 
