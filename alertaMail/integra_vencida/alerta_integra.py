...
msg['From'] = fromaddr 
msg['To'] = ', '.join(toaddr)
msg['Subject'] = "Hardsearch Alertas - Integrações"

body = ('''Atenção! Existem Integrações próximas do vencimento ou vencidas, Você deve acessar o sistema para varificar as mesmas.

Enviado por: Alertas Hardsearch - alerta_integra v0.20.0522''')
msg.attach(MIMEText(body)) 

filename = r'C:\Hardsearch\alertaMail\integra_vencida\arq.txt' 
