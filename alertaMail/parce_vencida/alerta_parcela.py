...
msg['From'] = fromaddr 
msg['To'] = ', '.join(toaddr)
msg['Subject'] = "Hardsearch Alertas - Parcelas"

body = ('''Atenção! Existem parcelas próximas do vencimento ou vencidas, Você deve acessar o sistema para varificar os mesmos.

Enviado por: Alertas Hardsearch - alerta_parcela v0.20.0522''')
msg.attach(MIMEText(body)) 

filename = r'C:\Hardsearch\alertaMail\parce_vencida\arq.txt' 
